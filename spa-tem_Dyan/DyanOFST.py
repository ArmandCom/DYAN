...
## NEXT STEP, INCLUDE THE WHOLE MODEL IN A CALLABLE FUNCTION WITHIN THE CLASS
...
class OFModel(nn.Module):
    def __init__(self, Drr, Dtheta, T, PRE, x_fra, y_fra):
        ...
        self.dsH = Decoder(self.esH.rr, self.esH.theta, y_fra, 0)
        self.dsV = Decoder(self.esH.rr, self.esH.theta, x_fra, 0)
